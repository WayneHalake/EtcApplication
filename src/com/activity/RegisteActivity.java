...
public class RegisteActivity extends Activity implements HttpCallBack {

	SimpleDateFormat fmtDate = new java.text.SimpleDateFormat("yyyy-MM-dd");

	public static RegisteActivity insistent;
		...
		save.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if (Pwd.getText().toString().equals(Spwd.getText().toString())) {
					...
					Log.d("data", data);
					HttpTask task = new HttpTask(RegisteActivity.this);
					task.setCallback(RegisteActivity.this);

					task.execute(Util.URL + Util.user, data);

				} else {
					Toast.makeText(RegisteActivity.this, "两次密码输入不一样！", 1);
				}
			}
		});
		...
		entrDate.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				DatePickerDialog dateDlg1 = new DatePickerDialog(
						RegisteActivity.this, d, date1.get(Calendar.YEAR),
		...
		gradDate.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				DatePickerDialog dateDlg2 = new DatePickerDialog(
						RegisteActivity.this, t, date2.get(Calendar.YEAR),
		...
		if (str != null) {
			try {
				...
				if (flag) {
					...
					// 设置结果码
					int RegisteResultcode = 5;
					startActivityForResult(intent, RegisteResultcode);
					RegisteActivity.this.finish();
				} else {

					Toast.makeText(RegisteActivity.this, "注册失败", 1).show();
				}
